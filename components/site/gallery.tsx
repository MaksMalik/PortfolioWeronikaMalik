      ...
      <div className="section-shell">
        ...
        <div className="relative mt-12">
          ...
          <div
            ...
            {...railDragHandlers}
            className={cn(
              "no-scrollbar grid auto-cols-[84%] grid-flow-col gap-5 overflow-x-auto touch-pan-x overscroll-x-contain touch-pan-x overscroll-x-contain pt-12 pb-20 -mt-12 -mb-16 select-none [scroll-snap-type:x_proximity] sm:auto-cols-[52%] lg:auto-cols-[calc((100%_-_2.5rem)/3)]",
